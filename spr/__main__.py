...
async def help_command(_, message: Message):
    ...
    kb = [
            [
                ikb("Help": "bot_commands"),
            ],
            [
                ikb("✚ Add me to your Group": f"https://t.me/{BOT_USERNAME}?startgroup=new"),
            ],
            [
                ikb("Channel": "https://t.me/CheemsUserbot"),
                ikb("Group": "https://t.me/CheemsBotChat"),
            ]
            ]
