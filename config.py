...
if not DEPLOYING_ON_HEROKU:
    BOT_TOKEN = "5557458280:AAG8O6-Kp85AgUhWZJ3E7OR-ZnKhyeZamIs"
    SUDOERS = [5545068262]
    NSFW_LOG_CHANNEL = "-1001667411233"
    SPAM_LOG_CHANNEL = "-1001667411233"
    ARQ_API_KEY = "GBGOGP-ZAUTAU-IJCFGH-GFDZQT-ARQ"  # Get it from @ARQRobot
else:
    BOT_TOKEN = env.get("BOT_TOKEN", "5557458280:AAG8O6-Kp85AgUhWZJ3E7OR-ZnKhyeZamIs")
