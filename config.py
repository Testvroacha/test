...
if not DEPLOYING_ON_HEROKU:
    ...
    SUDOERS = [5545068262]
    NSFW_LOG_CHANNEL = "-1001545810140"
    SPAM_LOG_CHANNEL = "-1001545810140"
    ...
    NSFW_LOG_CHANNEL = int(env.get("NSFW_LOG_CHANNEL", "-1001545810140"))
    SPAM_LOG_CHANNEL = int(env.get("SPAM_LOG_CHANNEL", "-1001545810140"))
